...
ctrl+shift+B	标尺综合	3.1.0	从一组给定的车次中读取选定区间的标尺数据，将弹出向导完成操作。
...
ctrl+7	标尺一览表	3.1.2	以表格形式，展示本线所有标尺的只读数据表。
ctrl+=	放大运行图	1.5.2	将运行图显示比例放大至当前的125%。
ctrl+-	缩小运行图	1.5.2	将运行图显示比例缩小至当前的80%。
F1	简明功能表	2.2.2	显示“简明功能表”帮助信息
F2	菜单栏开关	3.1.0	显示或隐藏菜单栏。3.1.0版本后，默认操作方式为工具栏，默认关闭菜单栏，如有需要，可用此功能打开。
